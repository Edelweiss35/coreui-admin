...
///////////////////////////////////
  render() {
    ...
    const { children, ...attributes } = this.props;
              //KSH-<i className="icon-people"></i>//<AppSwitch className={'mx-1'} color={'warning'} checked/> 
    return (
      <React.Fragment>
        <Nav tabs>
          <NavItem>
        ...
        <TabContent activeTab={this.state.activeTab}>
          ...
          <TabPane tabId="4" className="p-3" >
            <AppSwitch onClick = {this.switchState} color={'warning'} checked/>
              {this.state.switchFlag === true ? 
              <CardComponent/> : 
              <TableComponent/>}
          </TabPane>
        </TabContent>
